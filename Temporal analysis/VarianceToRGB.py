...
for depthIndex in range(650):   # dim_z
    # depthIndex = 447  # # #
    enfaceData = rawDataRotat[:, depthIndex, :]  # plt.figure(11);    plt.clf();    plt.plot(enfaceData[353, :])
    ...
    hueRange = [0, 20]  # variance
    satRange = [0, 10]  # intensity
    varProj_var = np.var(enfaceData_lp, axis=1)
