...
# vFrac = np.zeros([2, 46])  # vFrac[0, :] is the vFrac' which almost equals to vFrac, vFrac[1, :] is the std of vFrac over 30 depth slices
...
# ax3['a'].clear()
# ax3['a'].plot(timeRec, vFrac[0, :], color='#203878')
